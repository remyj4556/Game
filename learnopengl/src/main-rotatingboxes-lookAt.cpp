...
int main() {
	...
	// camera. cameraDirection subtracts the origin vector from the position. camera right takes cross product of up vector and direction
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// create a view and assign a lookAt matrix to it
		glm::mat4 view = glm::mat4(1.0f);
		view = glm::lookAt(glm::vec3(0.0f, 0.0f, 3.0f),       // position vector
